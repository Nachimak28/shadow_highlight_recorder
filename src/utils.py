...
def get_current_time():
    """Gives current time for indian time zone
    ...
    ist_time = current_time.strftime('%Y-%m-%d_%H-%M-%S')
    return ist_time




def filter_images_by_status(df, status_string):
    return df[df.status == status_string]
